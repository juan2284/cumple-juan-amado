...
export type RootsViewProps = {
  families: Family[];
  persons: Person[];
  dispatch: Dispatch<ListActions>;
}

export default function RootsView({families, persons, dispatch}: RootsViewProps) {
  return (
    <>
      <main className="h-svh bg-[url(roots.jpg)] bg-center p-4 flex flex-col justify-center gap-4">
